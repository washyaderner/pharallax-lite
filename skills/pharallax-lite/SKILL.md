...
This is a surface-level structural read based on publicly visible information. Three agents evaluated what a potential customer, investor, or competitor would see when they visit your site.

What it does not cover:
- Internal operations data would shift Clarity and Coherence scores significantly
- Your competitive surface was scored against publicly visible competitors only - the full analysis cross-references against 208,000+ indexed knowledge claims including patterns from 160+ industries
- The 3 highest-leverage moves for businesses at your score range require the adversarial dialogue engine, where 12 specialized personas stress-test each finding from orthogonal angles
- Cognitive bias detection, strategic blind spot identification, and a prioritized 90-day action plan require the full analysis depth

Your structural read is ready. The structural surgery is at [pharallax.ai](https://pharallax.ai)

---

*Generated by [Pharallax Lite](https://github.com/washyaderner/pharallax-lite) - open source structural business analysis for Claude Code*
```
